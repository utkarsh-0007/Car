...
const one=problem1(inventory,330);


const two=problem2(inventory);

const three=problem3(inventory);

const four=problem4(inventory);


const five=problem5(inventory,2000)


const six=problem6(inventory);